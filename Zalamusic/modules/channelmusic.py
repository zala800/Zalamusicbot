# Zalamusic (Telegram bot project)
...
from Zalamusic.modules.play import generate_cover
from Zalamusic.modules.play import arq
from Zalamusic.modules.play import cb_admin_check
from Zalamusic.modules.play import transcode
from Zalamusic.modules.play import convert_seconds
from Zalamusic.modules.play import time_to_seconds
from Zalamusic.modules.play import changeImageSize
from Zalamusic.config import BOT_NAME as bn
from Zalamusic.config import DURATION_LIMIT
from Zalamusic.config import UPDATES_CHANNEL as updateschannel
from Zalamusic.config import que
from Zalamusic.function.admins import admins as a
from Zalamusic.helpers.errors import DurationLimitError
from Zalamusic.helpers.decorators import errors
from Zalamusic.helpers.admins import get_administrators
from Zalamusic.helpers.channelmusic import get_chat_id
from Zalamusic.helpers.decorators import authorized_users_only
from Zalamusic.helpers.filters import command, other_filters
from Zalamusic.helpers.gets import get_file_name
from Zalamusic.services.callsmusic import callsmusic, queues
from Zalamusic.services.callsmusic.callsmusic import client as USER
from Zalamusic.services.converter.converter import convert
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/0e0509861103d84810678.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @{BOT_USERNAME} and @AliciaBotAssistant to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/0e0509861103d84810678.jpg"
